 ...
 */
class jobclub_elementor_job_list extends Widget_Base {
	/**
	 * Define our get_name settings.
	 */
	public function get_name() {
		return 'jobclub-job-list';
	}
	/**
	 * Define our get_title settings.
	 */
	public function get_title() {
		return __( 'Job Lists', 'jobclub' );
	}
	/**
	...
	public function render() {
		$settings = $this->get_settings();
		      if ( function_exists('job_manager_enqueue_styles') ) {
        job_manager_enqueue_styles();
    }
         echo do_shortcode('[jobs show_filters="true"]');
		
	}
	
}
/*=============Call this every widget ====================*/
Plugin::instance()->widgets_manager->register_widget_type( new jobclub_elementor_job_list() );
