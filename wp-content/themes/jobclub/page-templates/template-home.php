...
$about_sec_show = $jobclub_options['about_sec_show'];
$newsletter_sec_show = $jobclub_options['newsletter_sec_show'];
$blog_sec_show = $jobclub_options['blog_sec_show'];
$bottomblog_sec_show = $jobclub_options['bottomblog_sec_show'];
